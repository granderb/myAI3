...
export const AI_NAME = "VentureIQ";
export const OWNER_NAME = "Ben Grander";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, your AI-powered business advisor for entrepreneurs and startup founders. Ask me anything about strategy, fundraising, finance, or growing your business!.`
